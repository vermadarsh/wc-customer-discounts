...
class Wc_Customer_Discounts {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wc_Customer_Discounts_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'wc-customer-discounts';
	 ...
	 *
	 * - Wc_Customer_Discounts_Loader. Orchestrates the hooks of the plugin.
	 * - Wc_Customer_Discounts_i18n. Defines internationalization functionality.
	 * - Wc_Customer_Discounts_Admin. Defines all hooks for the admin area.
	 * - Wc_Customer_Discounts_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Wc_Customer_Discounts_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Wc_Customer_Discounts_i18n();
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wc_Customer_Discounts_Loader    Orchestrates the hooks of the plugin.
	 */
